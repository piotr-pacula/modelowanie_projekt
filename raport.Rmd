...
# Przekształcenie CRS dla grid100m
grid100m <- st_transform(grid100m, crs = st_crs(pop1km))

# Teraz możesz spróbować ponownie połączyć dane
pop_100m <- st_join(grid100m, pop1km, join = st_intersects)

# Obliczenie liczby mieszkań w każdej komórce siatki 100m
pop_100m$Liczba_mieszkani <- pop_100m$N_BUDYNKI / nrow(pop_100m)
```
